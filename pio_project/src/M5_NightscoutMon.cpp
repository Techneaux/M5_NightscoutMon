...
void setPageIconPos(int page) {
  switch(page) {
    ...
    case 2:
      ...
      break;
    case 3:  // New simplified glucose page
      icon_xpos[0] = 266;
      icon_xpos[1] = 266+18;
...
// Large full-width graph for simplified display page
void drawLargeGraph(struct NSinfo *ns) {
  int i;
  float glk;
  uint16_t sgvColor;
...
void draw_page() {
  ...
  switch(dispPage) {
    ...
    case 3: {
      ...
      // Determine glucose color based on thresholds
      uint16_t glColor = TFT_GREEN;
      if(ns.sensSgv < cfg.yellow_low || ns.sensSgv > cfg.yellow_high) {
        glColor = TFT_YELLOW;
      }
